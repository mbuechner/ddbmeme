...
def autocompleteModel(request):
    ...
    if (query is None) or not (len(query) == 81) or not query.startswith('https://www.deutsche-digitale-bibliothek.de/item/'):
        data['message'] = '<strong>Example?</strong> Try something like one: <a id="alert_example" href="#" class="alert-link">https://www.deutsche-digitale-bibliothek.de/item/CRHMM44XWLG7ZNH55BQ5GSAHTYLXJ7Z4</a>'
